...
<body>
    ...
    <section class="home">
        ...
        <div class="slide show"
            style="background-image: linear-gradient(to top, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.2)),url('images/img_nền/slide-2.jpg')">
        </div>
        <div class="slide"
            style="background-image:linear-gradient(to top, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.2)),url('images/img_nền/slide-3.jpg')">
        </div>
        <div class="slide"
            style="background-image: linear-gradient(to top, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.2)),url('images/img_nền/preview_img.jpg')">
        </div>
